...
export const GET = async (req: Request) => {
  try {
    ...
    // Get just the needed fields using projection
    ...
    const response = {
      word,
      syllables: firstSense.syllables || null,
      syllableBreakdown: firstSense.syllableBreakdown || [],
      pronunciationTips: firstSense.pronunciationTips || [],
    };
